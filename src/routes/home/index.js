...
export default class Home extends Component {
  ...
  generateDroneMarkerIcon() {
    ...
    const hdg =
      (this.state.telemetry && this.state.telemetry.position.hdg) || 0;
    ...
    let connect = async () => {
      ...
      if (hive._ws.readyState === 1) {
        ...
        hive.on("telemetry", data => {
          ...
          this.setState({
            ...
            mapMarker: {
              ...
              position: {
                lng: data.dev.position.lon,
                lat: data.dev.position.lat
              },
        ...
        this.setState({
          hive: {
            status:
              "The connection to the Hive is closed or couldn't be opened."
          }
        });
